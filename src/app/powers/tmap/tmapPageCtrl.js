(function () {
    ...
    angular.module('BlurAdmin.power.tmap')
        .controller('tmapPageCtrl', tmapPageCtrl);

    /** @ngInject */
    function tmapPageCtrl($scope, Log, HttpToast, $interval, $timeout, excepNumHelper, previewCache, arrUtil,
                              locals, ToastUtils, $state, $rootScope, clientCache, PageTopCache, Client, mapImgCache, userCache,
                              LineCount, lineTitlePieHelper, _, lineChartHelper, lineMaxDataHelper, lineMaxEleHelper,activeCidCache) {
...
//                    zoomEnable: false,      //是否可缩放
        ...
        $rootScope.$on('filterInfo', function (event, data) {
            ...
            if (data.cid) {
                activeCidCache.activeCid=data.cid;
            }
        });
